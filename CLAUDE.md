...
- Exposes `find_definition`, `find_references`, `rename_symbol`, `move_file`, `find_symbol_anywhere`, `find_definitions_batch`, `get_symbols_for_file`, and `get_symbol_info` tools
